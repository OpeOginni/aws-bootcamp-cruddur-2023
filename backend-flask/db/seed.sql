  ...
  (
    (
      ...
      from
        public.users
      WHERE
        users.handle = 'this_guy'
      LIMIT
        1
    ), 'No Its Not!', current_timestamp + interval '10 day'
  ),
  (
    (
      SELECT
      ...
      LIMIT
        1
    ), 'It sure is!', current_timestamp + interval '10 day'
  );